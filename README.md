...
| America's Army: True Soldiers | vsync = false<br>framerate_limit = 0 | [Yes](https://github.com/AdrianCassar/xenia-canary/wiki)
...
| Castle Crashers | apu_max_queued_frames = 16 | [Yes](https://github.com/AdrianCassar/xenia-canary/wiki)
| Castlevania: Harmony of Despair | internal_display_resolution = 16 | No
| Castlevania: Symphony of the Night | apu_max_queued_frames = 16 | No
| CellFactor: Psychokinetic Wars | vsync = false<br>framerate_limit = 0<br>draw_resolution_scale_x = 2<br>draw_resolution_scale_y = 2 | [Yes](https://github.com/AdrianCassar/xenia-canary/wiki)
| Chaotic Shadow Warriors | vsync = false<br>framerate_limit = 0 | No
...
| Crackdown | [Bleeding Lights Fix](https://github.com/xenia-canary/game-patches/blob/main/patches/4D5307DC%20-%20Crackdown%20(TU0).patch.toml)<br>use_dedicated_xma_thread = false<br>use_new_decoder = true<br>d3d12_readback_resolve = true<br>controller_hotkeys = true<br>(Turn off RR with A + Guide Button) | [Yes](https://github.com/AdrianCassar/xenia-canary/wiki)
...
| Devil May Cry 2013 | vsync = false<br>framerate_limit = 0 | No
...
| El Shaddai | vsync = false<br>framerate_limit = 0 | No
...
| Forza Horizon | mount_cache = true<br>gpu_allow_invalid_fetch_constants = true<br>vsync = false<br>framerate_limit = 0<br>use_new_decoder = true<br>use_dedicated_xma_thread = false | No
...
| Fracture | render_target_path_d3d12 = "ROV" | No
...
| Ghost Recon Advanced Warfighter 2 | Use TU 4<br>launch_module = "Yeti_Final_Xenon.xex" [Single-Player]<br>launch_module = "GRAW2Xbox 360_Release.xex" [Multi-Player]<br>vsync = false<br>framerate_limit = 0 | [Yes](https://github.com/AdrianCassar/xenia-canary/wiki)
...
| Lost Planet Extreme Conditions: Colonies Edition | clear_memory_page_state = true | [Yes](https://github.com/AdrianCassar/xenia-canary/wiki)
...
| Lost Planet 3 | query_occlusion_fake_sample_count = -1<br>vsync = false<br>framerate_limit = 0 |
...
| Marvel Ultimate Alliance | clear_memory_page_state = true<br>protect_zero = false<br>query_occlusion_fake_sample_count = -1<br>vsync = false<br>framerate_limit = 0<br>use_dedicated_xma_thread = false<br>use_new_decoder = true | [Yes](https://github.com/AdrianCassar/xenia-canary/wiki)
| Marvel vs. Capcom 2 | gpu_allow_invalid_fetch_constants = true<br>Set Character Graphic Mode to Classic | [Yes](https://github.com/AdrianCassar/xenia-canary/wiki)
| Mass Effect 1 | internal_display_resolution: 2-5<br>use_new_decoder = true<br>break_on_debugbreak = true | No
| Mass Effect 2 | render_target_path_d3d12 = "rov" | No
...
| Naruto: Rise Of A Ninja | clear_memory_page_state = true | No
...
| Ninety-Nine Nights | clear_memory_page_state = true | No
| No More Heroes: Heroes' Paradise | break_on_debugbreak = false<br>depth_float24_conversion = "truncate" | No
...
| Prince of Persia | disassemble_functions = true | No
...
| Shadow Complex | vsync = false<br>framerate_limit = 0 | No
...
| Thief | render_target_path_d3d12 = "rov" | No
